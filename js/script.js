...
//   Validate saving percentage value
  ...
  // console.log(balance);
  const remainingBalance = parseFloat(balance)- parseFloat(savingAmount);
  ...
  if (savingAmount > balance) {
    ...
    console.log(document.getElementsByClassName("remaining-balance"));
    document.getElementsByClassName("remaining-balance")[0].innerText = remainingBalance;
  }
};
